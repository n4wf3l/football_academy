    ...
    <div className="p-8">
      <div className="max-w-4xl">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Parametres du site</h1>
            <p className="text-gray-500 mt-1">Personnalisez l'apparence et le contenu de votre site</p>
          </div>
          <button
            onClick={handleSave}
            disabled={saving}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Nom de l'academie</label>
              <input
                type="text"
            ...
            <div>
              ...
              <div className="flex items-center gap-5">
                <div className="w-20 h-20 rounded-xl bg-gray-100 border-2 border-dashed border-gray-300 overflow-hidden flex-shrink-0 flex items-center justify-center">
                  {form.logo_url ? (
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-400">JPG, PNG, SVG ou WebP. Max 5 MB.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="flex items-center gap-3 px-5 py-3 rounded-xl border-2 border-gray-200 hover:border-primary transition-colors flex-1"
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-400">Fond fonce, tons verts</p>
              </div>
            </button>
            <button
              type="button"
            ...
            >
              <div className="flex gap-1">
                ...
                <div className="w-5 h-5 rounded-full bg-[#F8FAFC] border border-gray-300" />
              </div>
              <div className="text-left">
                <p className="text-sm font-semibold text-gray-900">Mode clair</p>
                <p className="text-xs text-gray-400">Fond clair, tons bleus</p>
              </div>
            </button>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {([
              ...
              { key: 'primary_light_color' as const, label: 'Principale claire' },
              { key: 'primary_dark_color' as const, label: 'Principale foncee' },
              { key: 'accent_color' as const, label: 'Couleur accent' },
              { key: 'dark_color' as const, label: 'Couleur sombre' },
            ]).map((item) => (
              <div key={item.key}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    value={form[item.key] || ''}
                    onChange={(e) => set(item.key, e.target.value)}
                    className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm font-mono focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
                    placeholder="#000000"
                  />
                </div>
              </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-gray-50 border border-gray-200">
            ...
            <div className="flex gap-3">
              {[
                ...
                { key: 'primary_dark_color' as const, label: 'Foncee' },
                { key: 'accent_color' as const, label: 'Accent' },
                { key: 'dark_color' as const, label: 'Sombre' },
              ].map((c) => (
                <div key={c.key} className="text-center">
                  <div className="w-12 h-12 rounded-lg shadow-sm mx-auto" style={{ backgroundColor: form[c.key] || '#000' }} />
                  <span className="text-xs text-gray-400 mt-1 block">{c.label}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Badge (etiquette)</label>
              <input
                type="text"
            ...
            <div>
              ...
              {form.hero_image_url && (
                <div className="mb-3">
                  <img src={form.hero_image_url} alt="Hero preview" className="w-full h-40 object-cover rounded-lg border" />
                </div>
              )}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Video de presentation (URL YouTube ou embed)</label>
              <input
                type="text"
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Utilisez un lien embed YouTube. Cette video sera affichee sur la page d'accueil.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
                  placeholder="contact@academie.com"
                />
              </div>
              <div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Adresse du centre de formation</label>
              <textarea
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <p className="text-sm text-gray-500 mb-4">Collez l'URL de vos profils. Laissez vide pour masquer un reseau.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {([
              ...
              <div key={social.key} className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: social.color + '15' }}>
                ...
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
